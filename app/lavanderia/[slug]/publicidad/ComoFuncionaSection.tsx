...
/**
 * Sección_Cómo_Funciona del vertical lavanderia — bloque explicativo estático
 * con encabezado propio (R4.1) que describe de forma secuencial el flujo de
 * extremo a extremo (R4.2): publicación de servicios → cotización del cliente →
  ...
  return (
    <section aria-labelledby="como-funciona-titulo" className="mt-8">
      ...
      <p className="mt-1.5 text-sm text-slate-500">
        De la cotización de servicios al pedido con tiquete, en cuatro pasos
        claros para el cliente y para ti.
      </p>
