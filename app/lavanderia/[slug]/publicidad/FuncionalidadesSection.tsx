...
/**
 * Sección_Funcionalidades del vertical lavanderia — bloque explicativo estático
 * con encabezado propio que agrupa las descripciones de gestión del
 * Panel_Dueño y el Puente_Cotización_Pedido (R5, R6, R7).
 *
 ...
 * `./content`): página pública de servicios y cotización (con total estimado y
 * landing compartible), gestión de servicios, promociones, cotizaciones,
  ...
  return (
    <section aria-labelledby="funcionalidades-titulo" className="mt-8">
      ...
      <p className="mt-1.5 text-sm text-slate-500">
        Desde la página pública de tus servicios hasta el pedido con tiquete,
        estas son las funcionalidades que la plataforma pone a tu disposición.
      </p>
